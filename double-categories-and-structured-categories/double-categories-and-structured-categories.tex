...
\begin{translator}{Note from the translator}
  ...
  Some of these correct minor typos and have been inserted silently; some are supplementary comments by Andrée Ehresmann and have been included verbatim, preceded by \emph{[Comm.]} and their comment number (when relevant).
