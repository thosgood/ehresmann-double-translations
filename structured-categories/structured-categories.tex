...
\newcommand{\comm}[1]{\marginpar{[Comm.] #1}}
...
\begin{rmenv}{Notation}
  We repeat here a few comments on notation and style from \cite[Comments on Part III-1, p.~337--338]{coll}, since there are a few conventions that the modern reader might find confusing.
...
\todo make comments from the collected works look good (tufte style?)
