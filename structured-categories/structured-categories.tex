...
\label{proposition:ii-16}
  Let $(\CC^{\perp_i})_{i\leq n}$ be an $n$-fold category satisfying the following condition: any two elements of $\CC$ that have the same set of vertices are identical.
