...
\label{definition:ii-19}
  ...
  \begin{enumerate}
    \item[\normalfont(1)]
      The map that sends $f\in\CC$ to the class of elements $f'<f$ is a generalised functor\comm{74.1}{This means that a morphism lesser than an identity is an identity, and that a morphism lesser than a composite $g\bullet f$ is of the form $g'\bullet f'$ with $g'<g$ and $f'<f$.} \cite{3a} from $\CC$ to $\CC$.
  \end{enumerate}
\end{definition}
