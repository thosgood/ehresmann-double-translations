...
\todo add citations to collected works (\texttt{coll})

\todo expand abbreviations (e.g. CRAS) in citations to collected works (\texttt{coll})
...
\begin{itemize}
  ...
  \item If $(\CC^\bullet,s)$ is an $\HH$-structured category, then the categories of trios and of quartets of $\CC^\bullet$ are $\HH$-structured categories.
\end{itemize}
...
\begin{corollary*}
  \oldpage{412}
  If $\HH'$ and $\HH''$ satisfy condition~($\sigma$) then, for $(\CC^\bullet,s)$ to be an $\HH((\HH',\HH'),\HH'')$-structured groupoid it is necessary and sufficient that it satisfy conditions~(1) and (3) of \cref{proposition:ii-28} as well as the following conditions:
  \begin{enumerate}
    \item[\normalfont(2\textquotesingle)]
      $(s,\alpha,s)\in\HH'$.
    \item[\normalfont(4)]
...
\begin{proof}
  ...
  \[
    (f',f)\longmapsto f'\bullet f=f
    \quad\text{if and only if}\quad
    f'=f.
  \]
  We have that $(s,\alpha,s)\in\Gamma$, since $\alpha(f)=f$ for all $f\in\CC$.
  By axiom~(R) of \cref{definition:i-9}~(\cref{section:i}), there exists $s'\subs s\times s$ such that $p(s')=\CC^\bullet\star\CC^\bullet$ is equal to the diagonal $\Delta$ of $\CC\times\CC$.
  The relations
  \[
  ...
  From the equalities
  \[
    (s',[\iota,\iota],s)\bullet(s,p_1\iota,s')=s'
    \textand
    (s,p_1\iota,s')\bullet(s',[\iota,\iota],s)=s
  \]
  it follows that
  \[
    (s,\chi^\bullet,s')
    ...
    \in\Gamma.
  \]
  Thus $(\CC^\bullet,s)$ is an $\overline{\HH}((\Gamma,\Gamma),\Gamma)$-structured category.
  Finally, the map
  \[
    (\overline{s},g,s)
    \longmapsto \big((p(\overline{s}),\overline{s}),g,(p(s),s)\big)
  \]
  is an isomorphism from $\HH$ to a full subcategory of $\overline{\HH}((\HH',\HH'),\HH'')$.\comm{86.3}{Let $|\cdot|\colon\overline{\HH}((\HH',\HH'),\HH'')\to\HH$ be the non-faithful functor mapping $F(\CC'^\bullet,s')\to(\CC''^\bullet,s'')$ to its restriction $F_0\colon s'_0\to s_0''$ to the objects; this functor admits a left adjoint, which maps $s$ onto the \emph{discrete structured category $(\CC^\bullet,s)$}.}
\end{proof}
...
\begin{proof}
  ...
  \[
    (\CC^\bullet,s),(\overline{\CC}^\bullet,\overline{s})
    \in\overline{\HH}(\HH',\HH'')_0
  \]
  imply that
  \[
    (\CC^\bullet\times\overline{\CC}^\bullet,s\times\overline{s})
    \in\overline{\HH}(\HH',\HH'')_0.
  \]
  ...
  \[
    ...
    \textand
    p(s_0\times\overline{s}_0)=(\CC^\bullet\times\overline{\CC}^\bullet)_0.
  \]
  \oldpage{415}
  Since
  \[
  ...
  \[
    p(s'')
    = (\CC^\bullet\times\overline{\CC}^\bullet)\star(\CC^\bullet\times\overline{\CC}^\bullet).
  \]
  ...
  \[
    \big(
      s\times\overline{s},
      (\chi^\bullet\times\overline{\chi}^\bullet)(\gamma\iota)^{-1},
      s''
    \big)
    \in\HH''.
  \]
  Thus $(\CC^\bullet\times\overline{\CC}^\bullet,s\times\overline{s})$ is an $\HH(\HH',\HH'')$-structured category.
\end{proof}
...
Let $(\CC^\bullet,s)$ be an $\HH$-structured category.
  ...
  \item[\normalfont(a)]
    ...
    \[
      \begin{aligned}
        \gamma_\alpha
        &= (s,p_2\iota,s_\alpha)
        = (s,p_2,s_0\times s)\bullet(s_0\times s,\iota,s_\alpha)
        \in\HH
      \\\overline{\gamma}_\alpha
        &= (s_\alpha,\alpha\times\iota,s\times s)\bullet(s\times s,[\iota,\iota],s)
        \in\HH
      \end{aligned}
    \]
    \oldpage{418}
    whence
    \[
      \overline{\gamma}_\alpha\bullet\gamma_\alpha = s_\alpha
      \textand
      \gamma_\alpha\bullet\overline{\gamma}_\alpha = s
    \]
...
\begin{proof}
  ...
  \]
  are $\HH(\HH',\HH)$-structured categories.
  If, further, $(\CC^\bullet,s)\in\overline{\GG}_0$\comm{92.2}{$\overline{\GG}=\overline{\GG}(\HH,\HH)$ by definition.}, then, again denoting by $j$ the map $f\mapsto f^{-1}$ in $\CC$, the relations
  \[
    \big(
      (s\times s)\times(s\times s),
  ...
  Now suppose that $(\CC^\bullet,s)\in\overline{\HH}((\HH',\HH'),\HH)_0$;
  by the above, we have that $(\vsq\CC^\bullet,\sq s)\in\overline{\HH}_0$.
  Let $\vsq s_0\subs\sq s$ be such that $p(\vsq s_0)=(\vsq\CC^\bullet)_0$.
  Let $\mu$ be the map $h\mapsto((h,\beta(h)),(\alpha(h),h))$ from $\CC$ to $(\vsq\CC^\bullet)_0$;
  the relations
  \[
    \begin{aligned}
      \overline{\mu}
  ...
  imply that
  \[
    \overline{\mu}\bullet\overline{\mu}' = \vsq s_0
    \textand
    \overline{\mu}'\bullet\overline{\mu} = s
  \]
  ...
  \[
    ...
    \big).
  \]
  Since $p(\overline{a}_1)(\sq\CC^\bullet)\subset p(s_1)$, we have, by \cref{proposition:i-10}~(\cref{section:i}), that
  \[
    \overline{a}'_1
    = \overline{a}_1
    \vdash_p (s_1,\sq s)
  ...
  \[
    ...
    \end{aligned}
  \]
  whence $\overline{a}_3\bullet\overline{a}_2\in\HH'$.
  Since $p(\overline{a}_3\bullet\overline{a}_2)(p(s_1))\subset p(s_{\beta\alpha})$, we find that
  \[
    \overline{a}'_2
    = (\overline{a}_3\bullet\overline{a}_2)
  ...
  \[
    ...
    = \overline{\mu}^{-1}\bullet\overline{\gamma}_{\beta\alpha}\bullet\overline{a}'_2\bullet\overline{a}'_1
    \in\HH'.
  \]
...
\begin{proof}
  ...
  If, further, $(\CC^\bullet,s)\in\overline{\GG}(\HH',\HH)_0$, then, for the same reason, we also have that $(\trio\CC^\bullet,\trio s)\in\overline{\GG}(\HH',\HH)_0$.
  ...
  \[
    \begin{aligned}
      ...
      &= (f',(e,h))
    \\\overline{a}_2
      &= (s\times s_0,\iota\times\alpha,s\times s)\bullet(s\times s,\iota\times\gamma_\beta,s\times s_\beta)
      \in\HH'
    \\\overline{a}_3
      &= \big(
        (s\times s)\times s_0,
  ...
  From the relations
  \[
    p(\overline{a}_1)(\trio\CC^\bullet)\subs p(s_1)
    \textand
  ...
  \[
    ...
    = \overline{a}_3\bullet\overline{a}'_2\bullet\overline{a}'_1
    \in\HH'
    \textand
    (\trio\CC^\bullet,\trio s)
    \in\overline{\HH}((\HH',\HH'),\HH)_0.
...
\begin{corollary*}
  ...
  \[
    ...
    = ((f',f),h).
  \]
  If $(\CC^\bullet,s)$ is an $\HH$-structured groupoid, then $\overline{\tau}\in\overline{\Gamma}$.
\end{corollary*}
...
\begin{proof}
  ...
  \]
  \oldpage{425}
  We will show that, if further $(\CC^\bullet,s)\in\overline{\GG}_0$, then we also have that $(\sq s,\tau^{-1},\trio s)\in\HH$.
  ...
  \[
    s_1\subs s\times s'
  \]
  where $p(s')=\CC^\bullet\star\CC^\bullet$, whence
  \[
    (s\times s,(\iota\times\chi^\bullet)\iota,s_1)
    \in\HH;
  \]
  since $(\iota\times\chi^\bullet)(p(s_1))\subset p(s')$, we find that
  \[
    \overline{b}_2
    = (s\chi^\bullet,s') \bullet (s',(\iota\times\chi^\bullet)\iota,s_1)
    \in\HH.
  \]
  By \cref{proposition:ii-4}, we have that
  \[
  ...
  \[
    ...
    = \big((h',f'),(f,h)\big).
  \]
  It thus follows that\comm{97.1}{``Pointwise'', these maps are \[((f',f),h)\xmapsto{\overline{b}_1}(f',(h,f^{-1}))\xmapsto{\overline{b}_2}f'\bullet h\bullet f^{-1}\] and \[((f',f),h)\xmapsto{\overline{b}_3}((f'\bullet h\bullet f^{-1},f'),(f,h)).\]}
  \[
    \overline{b}_3
    = \overline{\gamma}_1\bullet(\overline{b}_2\bullet\overline{b}'_1\times\trio s)\bullet(\trio s\times\trio s,[\iota,\iota],\trio s)
    \in\HH
  \]
  and
  \[
    p(\overline{b}_3)(\trio\CC^\bullet)
    = \tau^{-1}(\trio\CC^\bullet)
    \subset \sq\CC^\bullet.
  \]
  Thus
