...
\begin{longcomm}{29.2}
  ...
  $(\CC,p,\KK,\SS)$ is a category of homomorphisms if and only if $p\colon\KK\to\CC$ is a faithful (condition~(3)) functor (condition~(1)) whose restriction $\SS\to p(\SS)$ is (condition~(2)) a discrete opfibration.
  \todo
\end{longcomm}
