...
\begin{proof}
  ...
  \[
    (f',f)\mapsto f'\bullet f=f
    \quad\text{if and only if}\quad
    f'=f.
  \]
  We have that $(s,\alpha,s)\in\Gamma$, since $\alpha(f)=f$ for all $f\in\CC$.
  By axiom~(R) of \cref{definition:i-9}, there exists $s'\subs s\times s$ such that $p(s')=\CC^\bullet\star\CC^\bullet$ is equal to the diagonal $\Delta$ of $\CC\times\CC$.
  The relations
  \[
  ...
  \[
    (\overline{s},g,s)
    \mapsto \big((p(\overline{s}),\overline{s}),g,(p(s),s)\big)
  \]
