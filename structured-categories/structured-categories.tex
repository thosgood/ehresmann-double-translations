...
\label{theorem:2}
  The following conditions are equivalent:
  \begin{enumerate}
    \item $[\bar{h}']\subs_{\sq p}[\bar{h}]$ and $[\beta(\bar{h}')]\subs_{\sq p}[\beta(\bar{h})]$ in $(\vsq\CC,\sq p,\vsq\HH,\bar{\Gamma}')$;
    \item $\bar{h}'$ is a sub-homomorphism of $\bar{h}$ in $(\CC,p,\HH,\SS)$.
  \end{enumerate}
\end{itenv}
