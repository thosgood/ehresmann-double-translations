...
In particular, let $(\MM,p,\HH,\SS)$ be a category of homomorphisms such that $\MM$ is the category defined in Section~I.2.
Let $h\in\HH$;
...
\begin{rmenv}{Examples}
  ...
  \begin{enumerate}
    \item[1.]
      \oldpage{358}
      Let $(\MM,p_\FF,\FF)$ be the functor defined in Section~I.2;
